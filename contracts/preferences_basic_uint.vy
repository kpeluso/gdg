# @title Vyper Preferences Store - Basic Implementation for uint256 v1
...
@public
def setOpinion(_issue: uint256, _opinion: uint256) -> bool:
    assert self.owner == msg.sender
    assert not self.inDebate
...
@public
@constant
def getOpinion(_issue: uint256) -> uint256:
